    ...
    const mainServices = [
        {
            ...
            description: "Full project management and field activity services Pre-implementation design and consulting Site survey Installation On the-job training for your team"
        },
        {
            icon: Headphones,
            title: "24*7 Technical Support",
            description: "Maintaining your network is a top priority for Rudra Infocom. Our customer support team operates 24 hours a day, 7 days a week, to quickly resolve any issues."
        },
        {
            icon: Send,
            title: "Implementation and Maintenance Services",
            description: "To ensure network integrity & availability, Gemini offers customers implementation, training, support and maintenance services."
        }
    ];
        ...
        <div className="flex flex-col min-h-screen">
                        ...
                        {mainServices.map((service, index) => (
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <h3 className="text-2xl font-bold text-[#1e2d5f] mb-4">{service.title}</h3>
                                    <p className="text-gray-600">{service.description}</p>
                                </div>
                                <div
                                    className={`absolute bottom-0 left-0 w-full h-1 bg-[#1e2d5f] transform transition-transform duration-300 ${hoveredCard === index ? 'scale-x-100' : 'scale-x-0'
                                        }`}
                                />
                            </motion.div>
                        ))}
                    ...
                    >
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            <div className="md:w-1/2">
                                <h2 className="text-3xl md:text-4xl font-bold mb-6">IT Security Solutions</h2>
                                <p className="text-lg text-gray-200 mb-6">
                                    Security threats, be it physical or through IT, results in consequences & effect.
                                    SAAS offers a comprehensive security adoption.
                                </p>
                                <Link
                                    to="/contact"
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-[#1e2d5f] mb-4">Telecom Services</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Comprehensive telecommunication solutions tailored for your business needs
                        </p>
                    </motion.div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <motion.div
                        ...
                        className="text-center mb-12"
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-[#1e2d5f] mb-4">Salient Features</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                            Contact us today to learn more about our services and how we can help transform your business
                        </p>
                        <Link
                            to="/contact"
                            className="inline-block bg-white text-[#1e2d5f] px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition duration-300"
