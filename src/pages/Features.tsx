  ...
  const features: Record<string, Feature[]> = {
    network: [
      {
        ...
        description:
          "State-of-the-art network infrastructure designed for speed and reliability.",
      },
      {
        icon: Globe,
        title: "Global Connectivity",
        description:
          "Seamless integration with global networks for worldwide reach.",
      },
      {
        icon: Zap,
        title: "Low Latency",
        description:
          "Optimized routing for minimal latency and maximum performance.",
      },
    ],
    security: [
      {
        ...
        description:
          "Cutting-edge security measures to safeguard against evolving cyber threats.",
      },
      {
        icon: Eye,
        title: "Data Encryption",
        description:
          "End-to-end encryption for all your sensitive data transmissions.",
      },
      {
        icon: Eye,
    ...
    cloud: [
      ...
      },
      {
        ...
        description:
          "Redundant and secure cloud storage for all your critical data.",
      },
      {
        icon: Database,
        title: "Automatic Backups",
        description:
          "Regular automated backups to ensure data integrity and business continuity.",
      },
    ],
    support: [
      {
        ...
        description:
          "Expert technical assistance available 24/7, 365 days a year.",
      },
      {
        icon: Zap,
        title: "Rapid Response Time",
        description:
          "Quick resolution to your IT issues with our dedicated support team.",
      },
      {
        icon: Book,
        title: "Comprehensive Knowledge Base",
        description:
          "Access to extensive documentation and self-help resources.",
      },
    ],
  };
    ...
    <div className="flex flex-col min-h-screen">
            ...
            >
              {features[activeCategory].map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-[#1e2d5f] mb-2">
                    {feature.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Always up-to-date with the latest IT and telecom advancements",
              },
              {
                icon: Clock,
            ...
            {[
              {
                icon: Smartphone,
                title: "Consultation",
                description: "We start by understanding your unique needs",
              },
              {
                icon: Tool,
                title: "Custom Design",
                description: "Tailored solutions designed specifically for you",
              },
              {
                icon: Zap,
                title: "Rapid Deployment",
                description: "Swift and efficient implementation of services",
              },
              {
                icon: CheckCircle,
                title: "Ongoing Support",
                description:
                  "Continuous assistance to ensure optimal performance",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1e2d5f] mb-6">
            Ready to Experience Our Features?
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Let's discuss how Rudra Infocom's cutting-edge features can
