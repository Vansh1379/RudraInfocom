            ...
            >
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-[#1e2d5f] mb-4">
                    Our Contact Details
                  </h3>
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <span>
                        1, Akhilesh society, near mona park, Vejalpur road,
                        Jivrajpark, Ahmedabad - 380051
                      </span>
                    </motion.div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <details className="bg-gray-100 rounded-md p-4">
                      ...
                      <p className="mt-2 text-gray-600">
                        We offer a wide range of IT and telecommunication
                        services including network solutions, cybersecurity,
                    ...
                    <details className="bg-gray-100 rounded-md p-4">
                      ...
                      <p className="mt-2 text-gray-600">
                        Yes, we offer 24/7 technical support to ensure your
